...
class GrantDailySubscriptionTicketsServiceTests(TestCase):
  ...
  def test_resets_daily_count_for_active_subscription(self):
    ...
    SubscriptionPlanTicketPolicyFactory(plan_type=PlanType.FREE, daily_ticket_amount=30)
    ...
    self.assertEqual(ticket.daily_count, 30)
  ...
  def test_multiple_users(self):
    ...
    for u in users:
      SubscriptionFactory(user=u, plan_type=PlanType.FREE)
