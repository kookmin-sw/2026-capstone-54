...
class SaveTranscriptResultTaskTests(TestCase):
  ...
  def test_dispatches_report_when_last_pending_transcript_completes(self, _mock_url, mock_dispatch):
  ...
  @patch("interviews.services.regenerate_analysis_report_service.dispatch_report_task")
  def test_does_not_dispatch_when_other_transcripts_still_pending(self, mock_dispatch):
  ...
  @patch("interviews.services.regenerate_analysis_report_service.dispatch_report_task")
  def test_does_not_dispatch_when_no_pending_report(self, mock_dispatch):
  ...
  @patch("interviews.services.regenerate_analysis_report_service.dispatch_report_task")
  @patch("interviews.services.regenerate_analysis_report_service.get_resume_bundle_url", return_value="")
  def test_failed_transcript_still_triggers_dispatch_check(self, _mock_url, mock_dispatch):
  ...
  @patch("interviews.services.regenerate_analysis_report_service.dispatch_report_task")
  def test_skips_when_report_already_generating(self, mock_dispatch):
  ...
  def test_returns_turn_not_found_when_turn_missing(self):
