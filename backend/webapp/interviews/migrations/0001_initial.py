...
class Migration(migrations.Migration):
  ...
  operations = [
    migrations.CreateModel(
      ...
      fields=[
        ...
        (
          ...
          models.CharField(
            choices=[('practice', '연습 모드'), ('real', '실전 모드')],
            default='practice',
            max_length=20,
    ...
    migrations.CreateModel(
      ...
      bases=('interviews.interviewsession', ),
      managers=[
        ('objects', common.models.base_model.BaseModelManager()),
      ],
    ),
    migrations.CreateModel(
      name='InterviewAnalysisReport',
      fields=[
      ...
      options={
        ...
        'abstract': False,
        'indexes': [
          models.Index(fields=['-created_at'], name='interview_a_created_c1ac3f_idx'),
          models.Index(fields=['-updated_at'], name='interview_a_updated_4ba333_idx')
        ],
      },
      managers=[
        ('objects', common.models.base_model.BaseModelManager()),
