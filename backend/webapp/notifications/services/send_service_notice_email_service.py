...
class SendServiceNoticeEmailService(BaseSendEmailService):
  ...
  def execute(self):
    ...
    if not settings.is_opted_in(EmailNotificationType.SERVICE_NOTICE.value):
      return False

    self._send_email(
      subject=self.kwargs["subject"],
      template_name="notifications/email/service_notice.html",
      context={
