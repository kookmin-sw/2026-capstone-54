...
class JobCategoryModelTest(TestCase):
  ...
  def test_create_job_category(self):
    """JobCategory 생성 테스트"""
    job_category = JobCategoryFactory(emoji="💻", name="IT/개발")
  ...
  def test_job_category_ordering(self):
    ...
    JobCategoryFactory(emoji="🤝", name="Sales")
    JobCategoryFactory(emoji="💻", name="IT")
    JobCategoryFactory(emoji="👥", name="HR")
  ...
  def test_job_category_unique_name_allows_reuse_after_soft_delete(self):
    ...
    category1 = JobCategoryFactory(emoji="💻", name="IT/개발")

    category1.delete()

    category2 = JobCategoryFactory(emoji="🖥️", name="IT/개발")
