...
export function AccountUnregisterSection({ onDeleteAccount }: AccountUnregisterSectionProps) {
  return (
    <>
      <div className="mb-7">
        <h2 className="font-plex-sans-kr text-[20px] font-black tracking-[-0.4px] text-[#0A0A0A] mb-[5px]">계정 탈퇴</h2>
        <p className="text-[14px] text-[#6B7280] leading-[1.55]">탈퇴 후에는 복구가 불가능합니다</p>
      </div>
