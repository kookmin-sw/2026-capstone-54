...
export const useInterviewSessionStore = create<InterviewSessionStore>((set, get) => ({
  ...
  submitInterviewAnswer: (uuid, turnPk, answer, speechSegments, fallbackOptions) =>
    submitInterviewAnswer(set, get, uuid, turnPk, answer, speechSegments, fallbackOptions),
