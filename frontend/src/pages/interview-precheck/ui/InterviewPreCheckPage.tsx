    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        @keyframes ipc-checkPulse{
          0%,100%{box-shadow:var(--ipc-sw)}
          50%{box-shadow:0 0 0 3px rgba(9,145,178,.15),var(--ipc-sc)}
        }
        ...
        .ipc-nav{
          ...
          border-bottom:1px solid var(--ipc-card-border);
        ...
        .ipc-btn-primary{
          ...
          color:var(--ipc-btn-fg);background:var(--ipc-btn-bg);
        ...
        .ipc-stepper{
          ...
          background:var(--ipc-card-bg);border:1px solid var(--ipc-card-border);
          border-radius:8px;padding:14px 22px;
          margin-bottom:32px;box-shadow:var(--ipc-sw);
          animation:ipc-fadeUp .35s .05s ease both;
        }
        ...
        .ipc-check-card{
          ...
          box-shadow:var(--ipc-sw);transition:all .3s;position:relative;overflow:hidden;
        }
        ...
        .ipc-recap{
          ...
          box-shadow:var(--ipc-sw);margin-bottom:24px;
        ...
        .ipc-btn-start-main{
          ...
          color:var(--ipc-btn-fg);background:var(--ipc-btn-bg);
          border:none;border-radius:8px;padding:17px 44px;cursor:pointer;
          box-shadow:var(--ipc-sch);transition:all .2s;
        }
        ...
        .ipc-btn-start-back{
          font-size:13px;font-weight:600;color:var(--ipc-muted);
          background:none;border:none;cursor:pointer;
          display:block;margin:10px auto 0;
          text-decoration:underline;text-decoration-color:var(--ipc-card-border);
        }
        ...
        @media(max-width:768px){
          .ipc-precheck{padding:24px 16px 48px}
          .ipc-check-grid{grid-template-columns:1fr 1fr}
          .ipc-level-row{grid-template-columns:1fr 1fr}
          .ipc-cam-layout{grid-template-columns:1fr}
        }
        @media(max-width:480px){
          .ipc-nav{padding:0 16px}
          .ipc-check-grid{grid-template-columns:1fr}
          .ipc-level-row{grid-template-columns:1fr}
        }
      `}</style>
