...
export function PlanCards({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 max-w-container-md mx-auto mb-14 animate-[subFadeUp_.45s_ease_.12s_both]">
      ...
      <div className="bg-[#0A0A0A] text-white rounded-2xl p-7 sm:p-9 relative overflow-hidden transition-all duration-300 -translate-y-1 shadow-[0_8px_32px_rgba(0,0,0,.22),0_24px_56px_rgba(0,0,0,.14)] hover:-translate-y-2 hover:shadow-[0_12px_48px_rgba(0,0,0,.3),0_32px_72px_rgba(0,0,0,.18)]">
